#Tinha refatorado pra trabalhar com Decimal() mas eu perdi o arquivo no vai e vem entre aulas e a preguiça de refazer bateu.
#Então fica essa "solução" ai, já que o requisito foi cumprido, tá feito kkkkkkkkkk
while True:
